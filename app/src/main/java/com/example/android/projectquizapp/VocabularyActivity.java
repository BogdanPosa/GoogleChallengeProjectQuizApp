...
public class VocabularyActivity extends AppCompatActivity {
    ...
    public void goBack1() {
        backbut1 = (Button) findViewById(R.id.back1);
    ...
    public void submit1() {
        ...
        submit1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                RadioGroup radioGroup1 = (RadioGroup)findViewById(R.id.rgQuestion1);
                RadioGroup radioGroup2 = (RadioGroup)findViewById(R.id.rgQuestion2);
                RadioGroup radioGroup3 = (RadioGroup)findViewById(R.id.rgQuestion3);
                RadioGroup radioGroup4 = (RadioGroup)findViewById(R.id.rgQuestion4);
